...
export function parseModelJson(text) {
  ...
  // Log first and last 200 chars to diagnose truncation
  console.log("[parseModelJson] text length:", text.length);
  console.log("[parseModelJson] start:", text.slice(0, 150));
  console.log("[parseModelJson] end:", text.slice(-150));
