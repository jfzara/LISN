        ...
        {Object.entries(BIOME_META).map(([key, meta]) => (
          <button
            ...
            style={{
              ...
              color:       biomeFilter === key ? meta.color : "rgba(232,223,200,0.50)",
            }}
      ...
      <div style={S.legend}>
        {Object.entries(BIOME_META).filter(([k]) => k !== "all").map(([key, meta]) => (
          <button key={key} style={S.legendItem} onClick={() => setBiomeFilter(key)}>
            <span style={{ ...S.legendDot, background: meta.color, boxShadow: `0 0 5px ${meta.color}55` }} />
...
const S = {
  ...
  hoverCard: {
    ...
    borderRadius: 1, padding: "10px 16px",
    pointerEvents: "none",
  ...
  legendLabel: { fontSize: 10, letterSpacing: "0.13em", textTransform: "uppercase", fontFamily: "'DM Mono', monospace", color: "rgba(232,223,200,0.58)" },
  ...
  wSub:      { display: "block", fontSize: 8, letterSpacing: "0.24em", color: "rgba(232,223,200,0.40)", fontFamily: "'DM Mono', monospace", marginTop: 3 },
};
